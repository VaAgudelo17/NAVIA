...
WORLD_CLASSES_ES = {
    ...
    "electrical outlet on wall": ("toma de corriente", "f"),
    ...
    "black flat screen TV turned off": ("televisor", "m"),
    "large black rectangle on wall TV": ("televisor", "m"),
    "dark television monitor off": ("televisor", "m"),
